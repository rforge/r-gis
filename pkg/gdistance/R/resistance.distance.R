resistance.distance <-
function(id.xy, transition) #transition is a sparse matrix. transition is a sparse matrix with as row/column names the cell numbers. id.xy is a matrix of three rows: ids, x and y coordinates. Procedure based on Fouss et al. (2007))
{
