...
#* Use Haversine formula to calculate distance between two points specified by 
...
distVincenty <- function(p1, p2, a=6378137, b=6356752.3142, f=1/298.257223563) {
...
#* (in numeric degrees) using Vincenty inverse formula for ellipsoids
  ...
  s <- round(s, digits=3) #// round to 1mm precision
  return(s)
}
