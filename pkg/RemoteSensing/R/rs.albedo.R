...
rs.albedo.aster<-function(greenchan, nirchan, swirchan2, swirchan3, swirchan5, swirchan6) #ALBEDO: TERRA-Aster sensor
{
...
rs.albedo.landsat<-function(bluechan, greenchan, redchan, nirchan, chan5, chan7)
...
rs.albedo.modis<-function(redchan, nirchan, chan3, chan4, chan5, chan6, chan7)
...
rs.albedo.noaa<-function(redchan, nirchan)
